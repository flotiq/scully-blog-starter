...
let ContentBlogPostService = class ContentBlogPostService {
    ...
    batchCreateBlogpost(updateExisting, blogpostWithoutInternal, observe = 'body', reportProgress = false, options) {
    ...
    createBlogpost(blogpostWithoutInternal, observe = 'body', reportProgress = false, options) {
        let headers = this.defaultHeaders;
        // authentication (HeaderApiKeyAuth) required
        if (this.configuration.apiKeys && this.configuration.apiKeys["X-AUTH-TOKEN"]) {
            headers = headers.set('X-AUTH-TOKEN', this.configuration.apiKeys["X-AUTH-TOKEN"]);
    ...
    deleteBlogpost(id, observe = 'body', reportProgress = false, options) {
    ...
    getBlogpost(id, hydrate, observe = 'body', reportProgress = false, options) {
        if (id === null || id === undefined) {
    ...
    listBlogpost(page, limit, orderBy, orderDirection, hydrate, filters, observe = 'body', reportProgress = false, options) {
        let queryParameters = new HttpParams({ encoder: this.encoder });
    ...
    updateBlogpost(id, blogpostWithoutInternal, observe = 'body', reportProgress = false, options) {
        if (id === null || id === undefined) {
...
ContentBlogPostService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ContentBlogPostService, factory: ContentBlogPostService.ɵfac, providedIn: 'root' });
ContentBlogPostService.ctorParameters = () => [
    { type: HttpClient },
    { type: String, decorators: [{ type: Optional }, { type: Inject, args: [BASE_PATH,] }] },
    { type: Configuration, decorators: [{ type: Optional }] }
];
ContentBlogPostService.ngInjectableDef = ɵɵdefineInjectable({ factory: function ContentBlogPostService_Factory() { return new ContentBlogPostService(ɵɵinject(HttpClient), ɵɵinject(BASE_PATH, 8), ɵɵinject(Configuration, 8)); }, token: ContentBlogPostService, providedIn: "root" });
ContentBlogPostService = __decorate([ __param(1, Optional()), __param(1, Inject(BASE_PATH)), __param(2, Optional())
...
ContentMediaService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ContentMediaService, factory: ContentMediaService.ɵfac, providedIn: 'root' });
ContentMediaService.ctorParameters = () => [
    { type: HttpClient },
    { type: String, decorators: [{ type: Optional }, { type: Inject, args: [BASE_PATH,] }] },
    { type: Configuration, decorators: [{ type: Optional }] }
];
ContentMediaService.ngInjectableDef = ɵɵdefineInjectable({ factory: function ContentMediaService_Factory() { return new ContentMediaService(ɵɵinject(HttpClient), ɵɵinject(BASE_PATH, 8), ɵɵinject(Configuration, 8)); }, token: ContentMediaService, providedIn: "root" });
...
GraphQLService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: GraphQLService, factory: GraphQLService.ɵfac, providedIn: 'root' });
GraphQLService.ctorParameters = () => [
    { type: HttpClient },
    { type: String, decorators: [{ type: Optional }, { type: Inject, args: [BASE_PATH,] }] },
    { type: Configuration, decorators: [{ type: Optional }] }
];
GraphQLService.ngInjectableDef = ɵɵdefineInjectable({ factory: function GraphQLService_Factory() { return new GraphQLService(ɵɵinject(HttpClient), ɵɵinject(BASE_PATH, 8), ɵɵinject(Configuration, 8)); }, token: GraphQLService, providedIn: "root" });
...
InternalService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: InternalService, factory: InternalService.ɵfac, providedIn: 'root' });
InternalService.ctorParameters = () => [
    { type: HttpClient },
    { type: String, decorators: [{ type: Optional }, { type: Inject, args: [BASE_PATH,] }] },
    { type: Configuration, decorators: [{ type: Optional }] }
];
InternalService.ngInjectableDef = ɵɵdefineInjectable({ factory: function InternalService_Factory() { return new InternalService(ɵɵinject(HttpClient), ɵɵinject(BASE_PATH, 8), ɵɵinject(Configuration, 8)); }, token: InternalService, providedIn: "root" });
...
MediaService.ngInjectableDef = ɵɵdefineInjectable({ factory: function MediaService_Factory() { return new MediaService(ɵɵinject(HttpClient), ɵɵinject(BASE_PATH, 8), ɵɵinject(Configuration, 8)); }, token: MediaService, providedIn: "root" });
...
let SearchAPIService = class SearchAPIService {
    ...
    search(q, fields, page, limit, orderBy, orderDirection, contentType, aggregateBy, filters, postFilters, observe = 'body', reportProgress = false, options) {
        let queryParameters = new HttpParams({ encoder: this.encoder });
...
SearchAPIService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: SearchAPIService, factory: SearchAPIService.ɵfac, providedIn: 'root' });
SearchAPIService.ctorParameters = () => [
    { type: HttpClient },
    { type: String, decorators: [{ type: Optional }, { type: Inject, args: [BASE_PATH,] }] },
    { type: Configuration, decorators: [{ type: Optional }] }
];
SearchAPIService.ngInjectableDef = ɵɵdefineInjectable({ factory: function SearchAPIService_Factory() { return new SearchAPIService(ɵɵinject(HttpClient), ɵɵinject(BASE_PATH, 8), ɵɵinject(Configuration, 8)); }, token: SearchAPIService, providedIn: "root" });
SearchAPIService = __decorate([ __param(1, Optional()), __param(1, Inject(BASE_PATH)), __param(2, Optional())
], SearchAPIService);

const APIS = [ContentBlogPostService, ContentMediaService, GraphQLService, InternalService, MediaService, SearchAPIService];
...
export { APIS, AbstractPropertiesConfig, ApiModule, BASE_PATH, COLLECTION_FORMATS, Configuration, ContentBlogPostService, ContentMediaService, DataSource, GraphQLService, InlineObject1, InternalService, MediaService, SearchAPIService };
